postgres:
	docker run --name swd-postgres --network swd-network -p 5432:5432 -e POSTGRES_USER=root -e POSTGRES_PASSWORD=secret -e POSTGRES_DB=dental_clinic -d postgres:15-alpine
