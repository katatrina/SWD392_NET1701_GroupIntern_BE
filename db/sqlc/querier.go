...
type Querier interface {
	...
	GetPatientByTreatmentScheduleID(ctx context.Context, scheduleID int64) (GetPatientByTreatmentScheduleIDRow, error)
	...
	ListExaminationSchedulesByDentistID(ctx context.Context, dentistID int64) ([]ListExaminationSchedulesByDentistIDRow, error)
	...
	ListPatients(ctx context.Context) ([]User, error)
	...
	ListTreatmentSchedules(ctx context.Context) ([]ListTreatmentSchedulesRow, error)
	ListTreatmentSchedulesByDentistID(ctx context.Context, dentistID int64) ([]ListTreatmentSchedulesByDentistIDRow, error)
	ListTreatmentSchedulesByDentistName(ctx context.Context, dentistName string) ([]ListTreatmentSchedulesByDentistNameRow, error)
